...
func cmd_boxscore_misc_v2(cl *baller.Client) (interface{}, error) {
	var (
		fs      = flag.NewFlagSet("boxscore_misc_v2", flag.ExitOnError)
		verbose = fs.Bool("verbose", false, "")
		options baller.BoxscoreMiscV2Options
	)
	...
	return cl.BoxscoreMiscV2(&options)
}

func init() {
	methods["boxscore_misc_v2"] = cmd_boxscore_misc_v2
}
